    ...
    public class CrawlerService
    {
        ...
        public Task<bool> TryGetDocument(string bunzi, string ho, bool isSan)
        {
            try
            {
                ...
                driver.FindElement(By.XPath("/html/body/div[7]/div/div[1]/div[1]/a[3]")).SendKeys(Keys.Enter);
        ...
        public Task<bool> CheckValidation(string bunzi, string ho, bool isSan)
        {
            ...
            {
                webDriverWait.Until(ExpectedConditions.ElementExists(
                   By.XPath("/html/body/div[5]/div[2]/div[2]/div/div/div[1]/table/tbody")));

                // 자식 요소 검색
                var children = driver.FindElement(By.XPath("/html/body/div[5]/div[2]/div[2]/div/div/div[1]/table/tbody")).FindElements(By.TagName("tr"));
                string temp;
                string tempAddress;
                ...
                for (int i = 1; i <= children.Count; i++)
                {
                    ...
                    var handles_before = driver.WindowHandles;
                    // 열람 버튼 클릭
                    driver.FindElement(By.XPath("/html/body/div[5]/div[2]/div[2]/div/div/div[1]/table/tbody/tr[" + i.ToString() + "]/td[4]/p[2]/span/a")).Click();
                    webDriverWait.Until(e => handles_before.Count != driver.WindowHandles.Count);
                    ...
                    // 지번 로딩 대기
                    webDriverWait.Until(ExpectedConditions.ElementExists(
                              By.XPath("/html/body/div[1]/div/div[2]/div/div[1]/table[2]/tbody/tr[1]/td[1]/table/tbody/tr[3]/td[2]")));
                    // 지번 일치 확인
                    temp = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div/div[1]/table[2]/tbody/tr[1]/td[1]/table/tbody/tr[3]/td[2]")).Text;
        ...
        public Task<string> TryGetArea()
        {
            try
            {
                ...
                var children = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div")).FindElements(By.TagName("div"));
                ...
                for (int i = 1; i <= children.Count / 3; i++)
                {
                    ...
                    {
                        if(!IsElementPresent(By.XPath("/html/body/div[1]/div/div[2]/div/div[" + i.ToString() + "]/table[2]/tbody/tr[2]/td/table/tbody/tr[" + j.ToString() + "]/td[2]/span")))
                        {
                            continue;
                        }

                        area = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div/div[" + i.ToString() + "]/table[2]/tbody/tr[2]/td/table/tbody/tr[" + j.ToString() + "]/td[2]/span")).Text;

                        if (string.IsNullOrEmpty(area))
                        {
                            // 면적 분할, 합병에 의한 빈칸 체크
                            string merge = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div/div[" + i.ToString() + "]/table[2]/tbody/tr[2]/td/table/tbody/tr[" + j.ToString() + "]/td[3]")).Text;
        ...
        public Task<string> TryGetOwner()
        {
            try
            {
                ...
                for (int i = 1; i <= children.Count / 3; i++)
                {
                    ...
                    {
                        owner = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div/div[" + i.ToString() + "]/table[2]/tbody/tr[2]/td/table/tbody/tr[" + j.ToString() + "]/td[2]")).Text;

                        if (string.IsNullOrEmpty(owner))
                        {
                            // 소유자 말소로 인해 빈칸인 상황 대비
                            string malso = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div/div[" + i.ToString() + "]/table[2]/tbody/tr[2]/td/table/tbody/tr[" + j.ToString() + "]/td[1]")).Text;
